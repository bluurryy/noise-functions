...
use super::{
    cell::{calc_distance2, calc_distance3, calc_distance4, DistanceFn, ValueIndex},
    hash_primes2_hb, hash_primes3_hb, hash_primes4_hb, impl_noise234, inv_sqrt, primes,
};

const JITTER_2D: f32 = 0.437016;
const JITTER_3D: f32 = 0.396144;
const JITTER_4D: f32 = 0.366025;

const MAX_DISTANCE_COUNT: usize = 4;
...
impl CellValue {
    ...
    pub const fn value_index(mut self, value_index: ValueIndex) -> Self {
        self.value_index = value_index;
        self
    }
}

impl_noise234!(CellValue);
...
fn gen2([x, y]: [f32; 2], seed: i32, settings: CellValue) -> f32 {
...
fn gen3([x, y, z]: [f32; 3], seed: i32, settings: CellValue) -> f32 {
...
fn gen4([x, y, z, w]: [f32; 4], seed: i32, settings: CellValue) -> f32 {
