...
use super::{gradient_dot2, gradient_dot3, gradient_dot4, hash_primes2, hash_primes3, hash_primes4, impl_noise234, masked_add, masked_inc, masked_sub, nmasked_add, nmasked_sub, nmul_add, primes};

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct Simplex;

impl_noise234!(Simplex);

#[inline]
fn gen2([x, y]: [f32; 2], seed: i32, _: Simplex) -> f32 {
...
#[inline]
fn gen3([mut x, mut y, mut z]: [f32; 3], seed: i32, _: Simplex) -> f32 {
...
#[inline]
fn gen4([mut x, mut y, mut z, mut w]: [f32; 4], seed: i32, _: Simplex) -> f32 {
