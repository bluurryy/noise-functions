    ...
    for<'a> Seeded<&'a Noise>: Sample<DIM, [f32; DIM]>,
{
    ...
    fn sample(&self, pos: [f32; DIM]) -> f32 {
        ...
        weighted_fbm(base, octaves, gain, lacunarity, fractal_bounding, weighted_strength, 0, pos)
    }
}
    ...
    for<'a> Seeded<&'a Noise>: Sample<DIM, [f32; DIM]>,
{
    ...
    fn sample(&self, pos: [f32; DIM]) -> f32 {
        ...
        weighted_fbm(base, octaves, gain, lacunarity, fractal_bounding, weighted_strength, seed, pos)
    }
}
    ...
    LaneCount<LANES>: SupportedLaneCount,
{
    ...
    fn sample(&self, pos: Simd<f32, LANES>) -> f32 {
        ...
        weighted_fbm_a(base, octaves, gain, lacunarity, fractal_bounding, weighted_strength, 0, pos)
    }
}
    ...
    LaneCount<LANES>: SupportedLaneCount,
{
    ...
    fn sample(&self, pos: Simd<f32, LANES>) -> f32 {
        ...
        weighted_fbm_a(base, octaves, gain, lacunarity, fractal_bounding, weighted_strength, seed, pos)
    }
}
...
#[inline(always)]
fn weighted_fbm<Noise, const DIM: usize>(base: &Noise, octaves: u32, gain: f32, lacunarity: f32, fractal_bounding: f32, weighted_strength: f32, mut seed: i32, mut pos: [f32; DIM]) -> f32
where
    for<'a> Seeded<&'a Noise>: Sample<DIM, [f32; DIM]>,
{
    let mut sum = 0.0;
...
#[cfg(feature = "nightly-simd")]
#[inline(always)]
fn weighted_fbm_a<Noise, const DIM: usize, const LANES: usize>(base: &Noise, octaves: u32, gain: f32, lacunarity: f32, fractal_bounding: f32, weighted_strength: f32, mut seed: i32, mut pos: Simd<f32, LANES>) -> f32
where
    for<'a> Seeded<&'a Noise>: Sample<DIM, Simd<f32, LANES>>,
    LaneCount<LANES>: SupportedLaneCount,
{
