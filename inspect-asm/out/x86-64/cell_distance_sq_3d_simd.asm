inspect_asm::cell_distance_sq_3d_simd:
	push rbp
	push r15
	push r14
	push r13
	...
	cmpleps xmm0, xmm1
	movaps xmm2, xmm0
	andnps xmm2, xmmword ptr [rip + .LCPI4_0]
	andps xmm0, xmmword ptr [rip + .LCPI4_1]
	orps xmm0, xmm2
	addps xmm0, xmm1
	cvttps2dq xmm2, xmm0
	movd ecx, xmm2
	lea r11d, [rcx - 1]
	inc ecx
	movss xmm0, dword ptr [rip + .LCPI4_2]
	cmp r11d, ecx
	jle .LBB_1
.LBB_20:
	pop rbx
...
.LBB_5:
	...
	movaps xmm2, xmmword ptr [rip + .LCPI4_3]
...
.LBB_12:
	...
	jle .LBB_6
.LBB_14:
	addss xmm0, dword ptr [rip + .LCPI4_4]
	jmp .LBB_20