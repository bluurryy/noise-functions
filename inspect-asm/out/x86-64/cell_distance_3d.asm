inspect_asm::cell_distance_3d:
	...
	xorps xmm2, xmm2
	cmpnless xmm2, xmm0
	movss xmm1, dword ptr [rip + .LCPI6_0]
	movaps xmm3, xmm2
	andps xmm3, xmm1
	movss xmm4, dword ptr [rip + .LCPI6_1]
	andnps xmm2, xmm4
	orps xmm2, xmm3
	addss xmm2, xmm0
	cvttss2si r11d, xmm2
	movss xmm5, dword ptr [rip + .LCPI6_2]
	ucomiss xmm2, xmm5
	mov eax, 2147483647
	cmova r11d, eax
	xor edx, edx
	...
	lea edx, [r11 - 1]
	inc r11d
	movss xmm1, dword ptr [rip + .LCPI6_3]
	cmp edx, r11d
	jle .LBB_1
.LBB_19:
	xorps xmm0, xmm0
	sqrtss xmm0, xmm1
	addss xmm0, dword ptr [rip + .LCPI6_6]
	pop rbx
	pop r12
	pop r13
	pop r14
...
.LBB_5:
	...
	movss xmm4, dword ptr [rip + .LCPI6_4]
	movaps xmm5, xmmword ptr [rip + .LCPI6_5]
