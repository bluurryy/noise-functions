inspect_asm::open_simplex2s_2d_simd:
	movsd xmm0, qword ptr [rdi]
	movaps xmm4, xmm0
	shufps xmm4, xmm0, 85
	addss xmm4, xmm0
	mulss xmm4, dword ptr [rip + .LCPI19_0]
	shufps xmm4, xmm4, 0
	addps xmm4, xmm0
	movaps xmm1, xmm4
	shufps xmm1, xmm4, 255
	cvttss2si ecx, xmm1
	movss xmm0, dword ptr [rip + .LCPI19_1]
	ucomiss xmm1, xmm0
	mov edx, 2147483647
	cmova ecx, edx
	xor eax, eax
	...
	movaps xmm0, xmm4
	addss xmm0, xmm3
	movss xmm1, dword ptr [rip + .LCPI19_2]
	mulss xmm0, xmm1
	mov edx, eax
	xor edx, ecx
	...
	xor r8d, edx
	and r8d, 254
	movss xmm5, dword ptr [rip + .LCPI19_4]
	mov edx, esi
	xor edx, edi
	imul edx, edx, 668265261
	mov r9d, edx
	...
	movaps xmm6, xmm1
	mulss xmm6, xmm1
	movss xmm2, dword ptr [rip + .LCPI19_3]
	movaps xmm7, xmm2
	subss xmm7, xmm6
	movaps xmm6, xmm0
	mulss xmm6, xmm0
	...
	addss xmm9, xmm8
	mulss xmm9, xmm6
	addss xmm7, dword ptr [rip + .LCPI19_5]
	addss xmm7, xmm5
	movss xmm5, dword ptr [rip + .LCPI19_6]
	movaps xmm6, xmm1
	addss xmm6, xmm5
	addss xmm0, xmm5
	mulss xmm7, xmm7
...
.LBB_16:
	subss xmm3, xmm5
	ucomiss xmm3, dword ptr [rip + .LCPI19_11]
	jbe .LBB_17
	addps xmm1, xmmword ptr [rip + .LCPI19_13]
	movaps xmm3, xmm1
	mulps xmm3, xmm1
	subss xmm2, xmm3
	shufps xmm3, xmm3, 85
...
.LBB_6:
	ucomiss xmm5, xmm3
	jbe .LBB_7
	addps xmm1, xmmword ptr [rip + .LCPI19_10]
	movaps xmm3, xmm1
	mulps xmm3, xmm1
	subss xmm2, xmm3
	shufps xmm3, xmm3, 85
...
.LBB_21:
	...
	jmp .LBB_22
.LBB_17:
	addps xmm1, xmmword ptr [rip + .LCPI19_7]
	movaps xmm3, xmm1
	mulps xmm3, xmm1
	subss xmm2, xmm3
	shufps xmm3, xmm3, 85
	...
	jmp .LBB_22
.LBB_7:
	addps xmm1, xmmword ptr [rip + .LCPI19_9]
	movaps xmm3, xmm1
	mulps xmm3, xmm1
	subss xmm2, xmm3
	shufps xmm3, xmm3, 85
...
.LBB_22:
	...
	addss xmm0, xmm1
.LBB_23:
	mulss xmm0, dword ptr [rip + .LCPI19_14]
	ret